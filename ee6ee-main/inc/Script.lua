...
https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown") 
    ...
    if MsgText[1] == "تاك للكل" or MsgText[1] == "منشن للكل" then    
if not msg.Admin then return "⇠ هذا الامر يخص (الادمن,المدير,المنشئ,المطور) بس  \n" end
...
if MsgText[1] == "منشن" or MsgText[1] == "تاك"  then   
if not msg.Admin then return "⇠ هذا الامر يخص ( الادمن,المدير,المنشئ,المطور ) بس  \n" end
...
sendMsg(arg.chat_id_,arg.id_,'⇠ معليش اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس معاذ يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
if MsgText[1] == "مغادره" or MsgText[1] == "اطردني" or MsgText[1] == "احظرني" or MsgText[1] == "اطردني" then
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"⇠ معليش هذا الحساب محظور من سيرفرات حماية معاذ ") end
...
if utf8.len(Text:match("^قول (.*)$")) > 3000 then 
return sendMsg(msg.chat_id_,msg.id_," للاسف ماقدر اقول اكثر من 3000 حرف ")
end
