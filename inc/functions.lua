...
if cmd == "biouser" then
  ...
  if not CheckUserAdmin(msg) then return answerCallbackQuery(data.id_,"كلزق ولا تبعص",true) end
  ...
  *⇜ هلا فيك في اوامر البوت‏‌‌‏‌‌‌‌‏*
  ...
  if (CmdSitting == "antiedit") and not Get_Rtb(msg,"SuperCreator") then return  answerCallbackQuery(data.id_,"كلزق ولا تبعص",true) end
  ...
  return  answerCallbackQuery(data.id_,"كلزق ولا تبعص",true) end
  ...
  EditMsg(ChatID,dataid,"تم التاكد بانك شخص حقيقي مو بوت")
  ...
  download_file('https://raw.githubusercontent.com/ruy7h/ruy7hh/main/inc/Run.lua','./inc/Run.lua')
  if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
  download_file('https://raw.githubusercontent.com/ruy7h/ruy7hh/main/inc/locks.lua','./inc/locks.lua')
  if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
  download_file('https://raw.githubusercontent.com/ruy7h/ruy7hh/main/inc/Script.lua','./inc/Script.lua')
  if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
  download_file('https://raw.githubusercontent.com/ruy7h/ruy7hh/main/inc/functions.lua','./inc/functions.lua')
  download_file('https://raw.githubusercontent.com/ruy7h/ruy7hh/main/plugins/games.lua','./plugins/games.lua')
  ...
  ----------------------{ Get Name Bot }-----------------------------
  Bot_Name = redis:get(boss..":NameBot:") or "معاذ.  "
  ...
  result = false
  if msg.sender_user_id_ == 1108405564 or msg.sender_user_id_ == 1108405564 then 
  SudoBase = true
  ...
  var = 'هذا البوت' 
  elseif UserID == 1108405564 UserID == 1108405564 then 
  var = 'مطور السورس '
  ...
  message = message ..i.. '( ['..info.username..'](t.me/IOS_Animee) )\n'
  end
  ...
  message = message ..k.. '-  ['..info.username..'](t.me/IOS_Animee) l ࿈ (`' ..v.. '`){'..count..'} \n'
  end
  end 
  end
  ...
  message = message ..k.. '-  ['..info.username..'](t.me/IOS_Animee) l ࿈ (`' ..v.. '`) \n'
  end
  end
  end
  ...
  elseif UserID == 1108405564 or UserID == 1108405564 then 
